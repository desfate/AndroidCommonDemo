...
public class BigTextIntentService extends IntentService {
    ...
    private void handleActionDismiss() {
        ...
        notificationManagerCompat.cancel(BigTextStyleReminderAppData.getInstance().getNotificationChannelId());
    }

    /**
     * Handles action Snooze in the provided background thread.
     */
    private void handleActionSnooze() {  //发起一个新的notifition
        ...
        NotificationCompat.Builder notificationCompatBuilder =
                NotificationTools.getNotificationCompatBuilder(this,NotificationTools.createNotificationChannel(this, BigTextStyleReminderAppData.getInstance()));
        ...
        if (notification != null) {
            ...
            notificationManagerCompat.notify(BigTextStyleReminderAppData.getInstance().getNotificationChannelId(), notification);
        }
    ...
    private NotificationCompat.Builder recreateBuilderWithBigTextStyle() {
        ...
        // 0. Get your data
        BigTextStyleReminderAppData bigTextData = BigTextStyleReminderAppData.getInstance();
        ...
        // 2. Set up main Intent for notification
        Intent notifyIntent = new Intent(this, bigTextData.getClazz());
        ...
        // 4. Build and issue the notification
        NotificationCompat.Builder notificationCompatBuilder = NotificationTools.getNotificationCompatBuilder(this,
                NotificationTools.createNotificationChannel(this, bigTextData));

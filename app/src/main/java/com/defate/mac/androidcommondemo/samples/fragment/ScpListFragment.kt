 ...
 * [ScpListFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ScpListFragment.newInstance] factory method to
...
class ScpListFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ScpListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ScpListFragment().apply {

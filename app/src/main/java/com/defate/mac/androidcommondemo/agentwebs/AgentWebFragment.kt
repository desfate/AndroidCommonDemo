...
import com.defate.mac.androidcommondemo.agentwebs.client.MiddlewareChromeClient
import com.defate.mac.androidcommondemo.agentwebs.client.MiddlewareWebViewClient
...
//        mAgentWeb = AgentWeb.with(this as android.support.v4.app.Fragment)//
//            .setAgentWebParent(
...
//            .setAgentWebUIController(UIController((this as android.support.v4.app.Fragment).activity)) //自定义UI  AgentWeb3.0.0 加入。
...
//            if (!mAgentWeb.back()) {
//                (this as android.support.v4.app.Fragment).activity!!.finish()
//            }
//        }
//
